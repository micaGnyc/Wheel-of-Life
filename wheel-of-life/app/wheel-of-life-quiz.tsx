...
export default function WheelOfLifeQuiz({
  email,
  firstName,
  age,
  gender,
...
<section className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12">
  <div className="mx-auto max-w-4xl text-center">
    ...
    <Button
      ...
      size="lg"
      className="bg-primary text-lg font-semibold text-primary-foreground hover:bg-primary/90 px-12"
    >
      Start Quiz
    </Button>
    ...
    <button
      ...
      className="mt-8 animate-bounce text-primary transition-colors hover:text-primary/80"
